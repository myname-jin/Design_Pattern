...
public class UserMainView extends JFrame {
    ...
    private JPanel createButtonPanel() {
        ...
        ReservationCheckButton = createFunctionButton("예약 현황 조회하기", "현재 전체 예약 현황을 확인합니다");
        panel.add(ReservationCheckButton);
    ...
    public void addReservationCheckListener(ActionListener listener) {
        ReservationCheckButton.addActionListener(listener);
    }
